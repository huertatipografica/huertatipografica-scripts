...
class OpenTab(object):
    def __init__(self):
        ...
        self.w = vanilla.FloatingWindow(
            (360, 95),
            "Add or rename suffix",
            autosaveName="com.juandelperal.renamer.mainwindow",
        )
        self.w.text = vanilla.TextBox(
            (13, 15, 320, 20), "New suffix (include.)", sizeStyle="small"
        )
        ...
        self.w.remove = vanilla.CheckBox(
            (15, 60, 200, 20),
    ...
    def SavePreferences(self, sender):
        Glyphs.defaults[
            "com.juandelperal.renamer.mainwindow.suffix"
        ] = self.w.suffix.get()
        Glyphs.defaults[
            "com.juandelperal.renamer.mainwindow.remove"
        ] = self.w.remove.get()
    ...
    def LoadPreferences(self):
        try:
            self.w.suffix.set(
                Glyphs.defaults["com.juandelperal.renamer.mainwindow.suffix"]
            )
            self.w.remove.set(
                Glyphs.defaults["com.juandelperal.renamer.mainwindow.remove"]
            )
        except:
            return False
