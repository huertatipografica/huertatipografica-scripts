...
for thisLayer in selectedLayers:
	if hasRepeatedPaths(thisLayer) or hasRepeatedComponents(thisLayer) or not thisLayer.parent.mastersCompatible:
...
if glyphList:
	...
	Message("No dangerous glyphs", "There are not repeated components, paths with the same ammount of points or incompatible glyphs in current selection.", OKButton="Yeah")