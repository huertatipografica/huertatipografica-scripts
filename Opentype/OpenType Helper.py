...
class OpenTab(object):
	...
	def __init__(self):
		...
		self.w = vanilla.FloatingWindow( (360, 80), "OTHelper", autosaveName="com.juandelperal.OTHelper.mainwindow" )
	...
	def SavePreferences( self, sender ):
		Glyphs.defaults["com.juandelperal.OTHelper.mainwindow.suffix"] = self.w.suffix.get()

		return True

	def LoadPreferences( self ):
		try:
			self.w.suffix.set( Glyphs.defaults["com.juandelperal.OTHelper.mainwindow.suffix"] )
		except:
			return False
