...
class Replace(object):
    def __init__(self):
        self.w = vanilla.FloatingWindow(
            (360, 130),
            "OT Find and Replace",
            autosaveName="com.juandelperal.OTfindreplace.mainwindow",
        )
        self.w.text = vanilla.TextBox((13, 15, 250, 20), "Search", sizeStyle="small")
        self.w.find = vanilla.EditText(
            (15, 30, 200, 20),
            "search",
            sizeStyle="small",
        ...
        self.w.replace = vanilla.EditText(
            (15, 75, 200, 20),
            "replace",
            sizeStyle="small",
            callback=self.SavePreferences,
        ...
        self.w.go = vanilla.Button(
            (220, 30, 60, 30), "Replace", sizeStyle="small", callback=self.OTfindreplace
        )
    ...
    def SavePreferences(self, sender):
        Glyphs.defaults[
            "com.juandelperal.OTfindreplace.mainwindow.find"
        ] = self.w.find.get()
        Glyphs.defaults[
            "com.juandelperal.OTfindreplace.mainwindow.replace"
        ] = self.w.replace.get()
    ...
    def LoadPreferences(self):
        try:
            self.w.find.set(
                Glyphs.defaults["com.juandelperal.OTfindreplace.mainwindow.find"]
            )
            self.w.replace.set(
                Glyphs.defaults["com.juandelperal.OTfindreplace.mainwindow.replace"]
            )
        except:
            return False
