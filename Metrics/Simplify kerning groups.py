...
def setParent( layer ):
	...
	if left and thisFont.glyphs[ left ]:
		while left != thisFont.glyphs[ left ].leftKerningGroup and thisFont.glyphs[ left ].leftKerningGroup:
			left = thisFont.glyphs[ left ].leftKerningGroup

	if right and thisFont.glyphs[ right ]:
		while right != thisFont.glyphs[ right ].rightKerningGroup and thisFont.glyphs[ right ].rightKerningGroup:
